DROP TABLE IF EXISTS enrichment.events
DROP TABLE IF EXISTS enrichment.event_veris_supplemental_info
DROP TABLE IF EXISTS enrichment.incident_attacker_relationship
DROP TABLE IF EXISTS enrichment.event_attacker
DROP TABLE IF EXISTS enrichment.naics_reference
...
(
    ...
    infectious_potential_source             text,
    depth_of_impact_name                    text,
    depth_of_impact_source                  text,
    ...
    entity_location_of_affected_information text,
