...
def handle(event, context):
    ...
    valid_path_parameters, body = RequestUtils.validate_status_path_parameter(event["pathParameters"])
    ...
    status_code, body = WCaaSUtils.get_status_by_status_for_scan_user(status, user_id)
