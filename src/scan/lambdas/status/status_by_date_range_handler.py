...
def handle(event, context):
    ...
    valid_path_parameters, body = RequestUtils.validate_daterange_path_parameter(event["pathParameters"])
    ...
    status_code, body = WCaaSUtils.get_status_by_date_range_for_scan_user(start_date, end_date, user_id)
